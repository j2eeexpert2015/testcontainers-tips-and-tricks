 ...
 * (testcontainers/ryuk) while allowing the hub.image.name.prefix (ghcr.io/j2eeexpert2015/approved-images/)
 ...
 *   - hub.image.name.prefix=ghcr.io/j2eeexpert2015/approved-images/
